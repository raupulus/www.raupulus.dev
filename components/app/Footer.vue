                ...
                <div class="make-with-love">
                    ...
                    <div class="mt-1">
                        <svg viewBox="0 0 50 52" class="w-2 h-2" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <animateTransform attributeName="transform" type="rotate" values="-15; 15; -15;" begin="0s"
                                dur="4s" repeatCount="indefinite">
                            </animateTransform>
                        </svg>

                        <svg viewBox="0 0 261.76 226.69" class="w-2 h-2 inline" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <animateTransform attributeName="transform" type="translate"
                                values="0 0; 0 -12; 0 -8; 0 -4; 0 0;" begin="0s" dur="2s" repeatCount="indefinite">
                            </animateTransform>
                        </svg>
