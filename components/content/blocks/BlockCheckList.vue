<template>
  ...
  <div :id="checkList.id" class="r-checkbox-container">
    <div class="r-checkbox-box">

      <div v-for="(item, idx) in checkList.data.items" :key="idx" class="r-checkbox-item">
        <svg
v-if="item.checked" xmlns="http://www.w3.org/2000/svg" class="r-checkbox-item-icon" style="fill: #00b44e;"
        ...
        <svg
v-else xmlns="http://www.w3.org/2000/svg" class="r-checkbox-item-icon" style="fill: #808080;" height="1em"
          viewBox="0 0 448 512">
          <path
        ...
        <div class="r-checkbox-item-content" v-html="sanitizeHtml(replaceBreakLine(item.text))"/>
...
const checkList = props.block as BlockCheckListType
